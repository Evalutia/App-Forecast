...
export const CRITERIOS_COLUMNAS: CriterioRow[] = [
  ...
  { col: 'Rot.Real.[mes]', hoja: 'Detalle', que: 'Rotación diaria del mes SIN corregir por estacionalidad.',
    como: 'Unidades vendidas del mes ÷ días del mes con stock. Es a qué ritmo se vendió mientras hubo stock, sin ajustar por la época del año. Vacía si el stock del mes no superó el mínimo configurado del artículo.' },
  ...
  { col: 'V/E.[mes]', hoja: 'Detalle', que: 'Venta real del mes, o su extrapolación si hubo quiebre.',
    como: 'Con stock todo el mes: la venta real. Con quiebre: la venta se proyecta al mes completo, y cuanto menos duró el stock más se proyecta — pero nunca más del doble de lo realmente vendido, por poco que haya durado. Vacía si el stock del mes no superó el mínimo configurado del artículo.' },
...
const CRITERIOS_COLORES: { color: string | null; fg?: string; label: string; detalle: string }[] = [
  ...
  { color: COLOR_SINSTOCK, label: 'Gris', detalle: 'Mes completo con stock igual o por debajo del mínimo configurado del artículo.' },
